...
from transformer_network import TransformerModel  # Assuming you have a separate file for your TransformerModel
import os

root_path = 'E:/projects/docker-configuration-23/dockerfile/'
model_save_path = root_path + 'experiments/model/transformer_best.pth'
